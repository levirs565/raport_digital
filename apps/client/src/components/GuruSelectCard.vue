        ...
        <v-list-item>
          <template v-slot:prepend>
            <v-list-item-action start>
              <v-checkbox-btn :disabled="!!isItemDisabled && isItemDisabled(item)"
                :model-value="model.has(item.username)" @update:model-value="(value) => {
                  if (!value) {
          ...
          <v-list-item-subtitle v-if="!!isItemDisabled && isItemDisabled(item)" class="items-center">
