...
export class OperatorMataPelajaranService {
    ...
    async add(periodeAjarId: string, name: string, kelompok: string | null, usernameGuruPengampu: string[]) {
    ...
    async update(mapelId: string, name: string, kelompok: string | null, usernameGuruPengampu: string[]) {
        try {
