...
const siswaCsvSchema = z.object({
    ...
    NISN: input.NISN,
    nama: input.Nama,
    jenis_kelamin: (input["Jenis Kelamin"] == "Laki-Laki" ? "LAKI_LAKI" : "PEREMPUAN") satisfies JenisKelamin as JenisKelamin ,
...
export class OperatorSiswaService {
    ...
    async importCsv(stream: ReadableStream) {
        ...
        try {
            ...
            const parser = nodeStream.pipe(csvParse({
                columns: true
            }));
