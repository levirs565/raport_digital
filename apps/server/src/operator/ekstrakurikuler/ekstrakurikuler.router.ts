...
export class OperatorEkstrakurikulerRouter {
    ...
    router = this.trpc.router({
        getAll: this.trpc.operatorProcedure
            ...
            .query(async ({ input }) => await this.service.getAll(input.periodeAjarId)),
        ...
        add: this.trpc.operatorProcedure
            ...
            .mutation(async ({ input }) => await this.service.add(input.periodeAjarId, input.nama, input.usernameGuru)),
